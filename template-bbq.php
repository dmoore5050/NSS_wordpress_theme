...
<div class='contentWrap clearfix'>
  <div class='light clearfix'>
    <h3 class="emphasisTitle modules">Optional Headline</h3>
    <h3 class="emphasisTitle modules">And, More Optional Text...</h3>
  </div><!-- /.course_text_wrapper -->

  <section class='firstHalf'>
    <h4 class="homesub">More Info...</h4>
    ...
    <br>
    <br>
    <h4 class="homesub">Maybe A List of DOs or DON'Ts?</h4>
    <ul class="listStyle">
  ...
  <section class='lastHalf'>
    <img src="http://placehold.it/445x408">
  </section>
...
<div class='contentWrap'>
  <br>
  <h3 class="smallHeadline pull-center">
    Thank You For Your Support!
    <br><br>
    We Hope To See You At The Nashville Software School Cookout.
  </h3>
  <br>
</div><!-- /.contentWrap -->
