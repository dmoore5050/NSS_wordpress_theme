...
<div class='container clearfix'>
  <div class='contentWrap'>
    ...
    <div class='wrapper'>
      ...
      <h2 class="bodyTitle">
        Support NSS & Invest in Nashville’s Tech Future
      </h2>
      <p class='bodyText'>
        The implication of the above is that to make NSS self-sustaining we need a significant working capital endowment in order to bridge the gap between our investment in a cohort of students and our collection of the resulting placement fees or student repayments.  We have been able to successfully bootstrap NSS for its first year of operation. However, to reach long-term sustainability, we now need the support of theNashville community to help us build the endowment - our working capital reserve - that we need to fully fund the school.
      </p>
      <p class='bodyText'>
        You can support NSS by donating to either or both of our fund-raising campaigns.  The Cohort Three Campaign is designed to build our working capital reserve and help us afford to train our third cohort of students.  Cohort 3 starts training on September 9, 2013 and will complete the first half of our Bootcamp program at the end of November.  Our goal is to raise at least $50,000 towards to costs of instructors, facilities and stipends in support of Cohort 3 by  November 30.
      </p>
      <p class='bodyText'>
        The NSS Capital Campaign will launch in September.  The goal of this campaign is to help us raise the capital required to equip our own facility with the furniture and fixtures that we need to better meet Nashville’s ongoing tech workforce development needs.  It will allow us to equip two full classrooms for both day-time and night-time classes.  It will provide adequate space to allow our mentors room to work alongside our students on class projects as well as allow students to work on apprenticeship projects after their graduation from the Bootcamp.
      </p>
      <p class='bodyText'>
