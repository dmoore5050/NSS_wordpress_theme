		...
		<div class="sectionWrap clearfix">
			<section class="clearfix">
										...
										<div class="imgPop">
											...
											<div class="infoPlace" style="margin-top:-40px;">
												<a href="#<?php the_ID();?>" data-reveal-id="<?php the_ID();?>" data-animation="fade" data-animationspeed="300">
												  <img src="<?php bloginfo('template_directory'); ?>/images/add.png" width="22px"/>
												</a>
											...
											<ul class="peopleInfo">
												...
												<li class = "infoItem">
													<p class="tags"> <?php $posttags = get_the_tags(); if ($posttags) { foreach($posttags as $tag) {echo $tag->name . '';	}} ?> </p>
												</li>

												<li class="infoItem infoMargin">
													<a class="format_text" href="http://<?php $personalLink = get_post_meta( get_the_ID(), 'personalLink', true);echo $personalLink;?>" class = "class"> <?php echo $personalLink;?></a>
												</li>

												<li class="infoItem infoMargin">
													<a class="format_text_lower" href="http://<?php $twitterLink= get_post_meta( get_the_ID(), 'twitterLink', true );echo $twitterLink;?>"> <?php $twitterID= get_post_meta( get_the_ID(), 'Twitter', true ); echo $twitterID;?></a>
												</li>
				...
				<section id="partners">
					...
					<div>
						<p style="text-align: center;">If your company is interested in learning how you can support the Nashville Software School and hire our students, please inquire to John Wark at Nashville Software School via the <a class="linkStyle" href="<?php echo esc_url( get_permalink( get_page_by_title( 'program' ) ) ); ?>">Contact page.</a></p>
					</div>
