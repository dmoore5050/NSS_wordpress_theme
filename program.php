...
?>
<?php get_header(); ?>
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/CSS/programlandingStyle.css">
<style>
	.darkBack, .dark {
...
<div class='contentWrap'>
	<section class='firstHalf'>
		<h3 class="programLandingTitle">Web Developer Bootcamp</h3>
		<div class='headImg'>
			<img class="headImageBorder img" src="<?php bloginfo('template_url'); ?>/images/NSS_Sam.jpg" alt="first_class" width="400px;" height="180px"/>
		</div>
		<p>Web Developer Bootcamp is a two-part, 6 month, full-time program that gives you the skills needed to find work as a entry- or junior-level software developer here in Nashville. Our students leave with experience in "full stack" development of web applications - from controlling the styling of the browser front-end of the application through dynamic front-end logic connected to the business logic and database on the back-end or server side of the application.</p>
		<a href="<?php echo esc_url( get_permalink( get_page_by_title( 'bootcamp' ) ) ); ?>"><button class="button orange applyBtn btnPlace">Learn More</button></a>
	</section>

	<section class='lastHalf'>
		<h3 class="programLandingTitle">Evening Classes</h3>
		<div class='headImg'>
		...
		<a href="<?php echo esc_url( get_permalink( get_page_by_title( 'evenings' ) ) ); ?>"><button class="button orange applyBtn btnPlace">Learn More</button></a>
	</section>
</div>
